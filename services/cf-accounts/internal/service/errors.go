...
var (
	...
	ErrIdentityProviderNotConfigured = cferrors.New(cferrors.CodeInternal, "identity provider is not configured")
	ErrIdentityProviderUnavailable   = cferrors.New(cferrors.CodeUnavailable, "identity provider unavailable")
