...
func NewResolveTenantRequest(server string, params *ResolveTenantParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.AccountId != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "accountId", *params.AccountId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: "uuid"}); err != nil {
				return nil, err
			} else {
		...
		if params.ApiKeyHash != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "apiKeyHash", *params.ApiKeyHash, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func (r ResolveTenantResponse) ContentType() string {
	if r.HTTPResponse != nil {
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r LoginWithPasswordResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
